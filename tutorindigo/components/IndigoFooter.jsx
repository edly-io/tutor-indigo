...
const IndigoFooter = () => {
  ...
  const messages = {
    ...
    "footer.navlink.courseCatalog": {
      id: "footer.navlink.courseCatalog",
      defaultMessage: "Course Catalog",
      description: "Footer navigation link",
    },
    "footer.navlink.instructorJoin": {
      id: "footer.navlink.instructorJoin",
      defaultMessage: "Instructor Join",
      description: "Footer navigation link",
    },
    "footer.navlink.partners": {
      id: "footer.navlink.partners",
      defaultMessage: "Partners",
      description: "Footer navigation link",
    },
    "footer.navlink.partnersJoin": {
      id: "footer.navlink.partnersJoin",
      defaultMessage: "Partners Join",
      description: "Footer navigation link",
    },
  };
        ...
        <div className="footer-social-row">
          <div className="footer-container">
            <nav className="social-nav">
              ...
              <ul>
                <li>
                  <a href="https://www.instagram.com/rwaq/" target="_blank">
            ...
            <nav className="privacy-nav">
              <ul>
                <li>
                  <a href={`${config.ENABLE_HTTPS ? 'https' : 'http'}://site.${config.BASE_URL}/courses/`}>
                    {intl.formatMessage(messages["footer.navlink.courseCatalog"])}
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href={`${config.ENABLE_HTTPS ? 'https' : 'http'}://site.${config.BASE_URL}/instructor-join/`}>
                    {intl.formatMessage(messages["footer.navlink.instructorJoin"])}
                  </a>
                </li>
                <li>
                  <a href={`${config.ENABLE_HTTPS ? 'https' : 'http'}://site.${config.BASE_URL}/partners/`}>
                    {intl.formatMessage(messages["footer.navlink.partners"])}
                  </a>
                </li>
                <li>
                  <a href={`${config.ENABLE_HTTPS ? 'https' : 'http'}://site.${config.BASE_URL}/partners-join/`}>
                    {intl.formatMessage(messages["footer.navlink.partnersJoin"])}
                  </a>
                </li>
                <li>
